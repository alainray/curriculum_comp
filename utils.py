...
def get_args():
    ...
    parser.add_argument("method", type=str)     # std/curr/anti/spl/spcl/inc
    parser.add_argument("lr", type=float)
    parser.add_argument("--train_ds", type=str, default="imagenet") # imagenet/cifar10/cifar100
    parser.add_argument("--test_ds", type=str, default="")
    parser.add_argument("--a", type=float, default=0.8, help="Proportion of training to get to full data")
    parser.add_argument("--b", type=float, default=0.2, help="Proportion of starting training data")
    parser.add_argument("--pacing", type=str, default="linear", help="Function for determining new amount of data") 
